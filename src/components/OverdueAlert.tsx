      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            <span className="font-semibold text-foreground">{overdueStudentIds.size}</span> aluno{overdueStudentIds.size !== 1 ? 's' : ''} com{' '}
            <span className="font-semibold text-foreground">{overduePayments.length}</span> pagamento{overduePayments.length !== 1 ? 's' : ''} pendente{overduePayments.length !== 1 ? 's' : ''}
          </p>
