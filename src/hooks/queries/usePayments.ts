...
export function usePayments() {
    ...
    useEffect(() => {
        if (!user || loadingProfile || loadingPayments) return;
    ...
    }, [user, loadingProfile, loadingPayments, payments, queryClient, profile?.business_type]);
