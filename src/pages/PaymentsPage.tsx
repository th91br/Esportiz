      ...
      <main className="container py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="card-elevated p-4">
            ...
            <p className="font-display text-2xl font-bold text-foreground">{privacyMode ? '••••' : `R$ ${totalAmount.toFixed(2)}`}</p>
          </div>
          <div className="card-elevated p-4">
            ...
            <p className="font-display text-2xl font-bold text-emerald-600 dark:text-emerald-400">{privacyMode ? '••••' : `R$ ${totalPaid.toFixed(2)}`}</p>
          </div>
          <div className="card-elevated p-4">
            <div className="flex items-center gap-2 text-sm mb-1 text-amber-600 dark:text-amber-400">
              <Clock className="h-4 w-4" /> Pendente
            </div>
            <p className="font-display text-2xl font-bold text-amber-600 dark:text-amber-400">{privacyMode ? '••••' : `R$ ${totalPending.toFixed(2)}`}</p>
          </div>
          <div className="card-elevated p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-sm text-muted-foreground mt-1 flex flex-wrap gap-x-4 gap-y-1">
                      ...
                      {payment.isProrata && payment.fullPrice ? (
                        <span>
                          <span className="line-through opacity-60">R$ {payment.fullPrice.toFixed(2)}</span>
                          {' → '}
                          <span className="font-semibold text-primary">R$ {payment.amount.toFixed(2)}</span>
                        </span>
                      ) : (
