...
export default function PaymentsPage() {
  ...
  // Current month is auto-generated by usePayments hook.
  // Only generate payments when viewing OTHER months (past or future).
  const currentMonthRef = now.toISOString().slice(0, 7);
                ...
                <div key={payment.id} className="card-elevated p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {payment.isProrata && (
                        <Badge className="text-xs bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400 border-violet-200 dark:border-violet-800" title="Valor proporcional aos dias restantes do primeiro mês">
                          <Percent className="h-3 w-3 mr-0.5" /> 1º Mês (Pro-rata)
                        </Badge>
                      )}
                    </div>
